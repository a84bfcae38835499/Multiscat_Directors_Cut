...
for fileprefix in fileprefixes:
    ...
    latticeFile = open(fileprefix + '.IFVPNPHS2', 'r')
    count = 0 
            ...
            for b in bools:
                ...
                if(not vanity):
                    if(showB):
                        ...
                        plt.annotate("b1", (b1[0]*Nsuper,b1[1]*Nsuper+0.2),color=b1col,fontsize=vectorFontSize,path_effects=pathefts1,zorder=11)
                        plt.annotate("b2", (b2[0]*Nsuper,b2[1]*Nsuper+0.1),color=b2col,fontsize=vectorFontSize,path_effects=pathefts1,zorder=11)
                    if(showA):
                        ...
                        plt.annotate("a1", (a1[0]/np.sqrt(a1[0]**2+a1[1]**2),a1[1]/np.sqrt(a1[0]**2+a1[1]**2)),color=a1col,fontsize=vectorFontSize,weight='bold',zorder = 5)
                        plt.annotate("a2", (a2[0]/np.sqrt(a1[0]**2+a1[1]**2),a2[1]/np.sqrt(a1[0]**2+a1[1]**2)),color=a2col,fontsize=vectorFontSize,weight='bold',zorder = 5)
